...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(related_name='content_modified_by', on_delete=django.db.models.deletion.SET_NULL, to='authentication.UserDetails', null=True),
        ),
        migrations.AddField(
            model_name='content',
            name='organization',
        ...
        migrations.AddField(
            model_name='content',
            name='uploaded_by',
            field=models.ForeignKey(related_name='content_uploaded_by', on_delete=django.db.models.deletion.SET_NULL, to='authentication.UserDetails', null=True),
        ),
    ]
